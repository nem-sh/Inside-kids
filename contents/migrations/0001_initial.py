    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.kid')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
            fields=[
                ...
                ('file_source', models.FileField(upload_to='')),
                ('analysis', models.CharField(blank=True, max_length=50, null=True)),
