...
glow_tts = load_glow_tts(
    config_path='/home/ubuntu/tts-test/contents/tts/content/data/glow-tts/config.json',
    checkpoint_path='/home/ubuntu/tts-test/contents/tts/content/data/glow-tts/G_3555.pth'
)

mb_mean, mb_sigma = load_stats(
    stats_path='/home/ubuntu/tts-test/contents/tts/content/data/mb-melgan/stats.npy'
)

mb_melgan, pqmf = load_mb_melgan(
    config_path='/home/ubuntu/tts-test/contents/tts/content/data/mb-melgan/config.yml',
    model_path='/home/ubuntu/tts-test/contents/tts/content/data/mb-melgan/generator-675257.h5'
)
