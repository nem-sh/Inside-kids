<template>
  <div class="row my-5 mx-5">
    ...
    <div class="col-12 text-center my-auto">
      <v-btn @click="moveToChildPage" outlined color="deep-orange lighten-3"
        ><v-avatar width="25" min-width="25" height="25" class="mr-3"
          ><img
            src="../../assets/sisongHead.png"
            alt="kids-profile" /></v-avatar
        >{{ kid.name }} 놀이터 이동
      </v-btn>
    </div>
  </div>
